    export const ChartModalHandler = {
       ...
       const ChartsUtils = {
        ...
        getChartsCurrencies: (currencySelections)=>[currencySelections.convertFrom, ...currencySelections.convertTo],
        ...
        getChartsCurrenciesWithSize: (currencySelections,currencyInfo)=>ChartsUtils.getChartsCurrencies(currencySelections).map(name=>{
            return {currency: name, size: ChartsUtils.getIndividualChartSize(name, currencySelections, currencyInfo)}
        }),
      ...
      getIndividualChartSize: (value, currencySelections,currencyInfo)=> {
          return parseFloat(currencyInfo.rates[value]) / parseFloat(currencyInfo.rates[ChartsUtils.getMaxUnitsOfChartCurrs(currencySelections,currencyInfo)]) * 100
      },
      ...
      getChartsOrientation: (isSmallScreen)=> isSmallScreen ? 'width' : 'height',
