...
export const SelectHandling = {
        // simple utility method to alphabetize string arrays, avoid mutating the original argument
        ...
        alphabetizeStringArr: (strArr) => {
            const arrayCopy = [...strArr].sort();
            return arrayCopy;
        },
        ...
        convertSelectKeys: ({selectState, appRefs},MaxNumOfComparisons, e)=> {
            ...
            if (selectState.prevConvertIndex === 0 && e.keyCode === 38) {
                ...
                // flash if exceeds allowable num of selections
                    ...
                    newArr = this.alphabetizeStringArr(newArr);
                }
